...
sk_client = None  # Persistent Signal K HTTP client connection pool
...
async def push_to_signal_k(path: str, value: float):
    ...
    try:
        # Reuses the existing connection socket instantly over local loopback
...
async def lifespan(app: FastAPI):
    ...
    yield
    bg_task.cancel()
    # Closes the persistent Signal K network socket immediately on system exit
